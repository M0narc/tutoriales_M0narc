...
# #                                        epoch = day and time when your computer thinks time began (reference point)
...
# https://docs.python.org/3/library/time.html  that's the documentation for the time module
# the line below will display current day, full name of the month, year and time using various "directives"
